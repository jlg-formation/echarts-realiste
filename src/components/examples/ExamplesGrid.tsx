...
const examplesData: Record<string, Example[]> = {
  line: [
    ...
    },
    {
      ...
      category: "line",
      internalLink: "/line/stacked-line-chart",
    },
    {
      id: "area-stack",
      title: "Stacked Area Chart",
      category: "line",
      internalLink: "/line/stacked-area-chart",
    },
    {
  ...
  pie: [
    ...
    },
    {
      ...
      category: "pie",
      internalLink: "/pie/doughnut-chart-with-rounded-corner",
    },
    {
      id: "pie-doughnut",
      title: "Doughnut Chart",
      category: "pie",
      internalLink: "/pie/doughnut-chart",
    },
    {
      id: "pie-half-donut",
      title: "Half Doughnut Chart",
      category: "pie",
      internalLink: "/pie/half-doughnut-chart",
    },
    {
      id: "pie-padAngle",
      title: "Pie with padAngle",
      category: "pie",
      internalLink: "/pie/pie-with-pad-angle",
    },
    {
      id: "pie-custom",
  ...
  candlestick: [
    ...
    },
    {
      ...
      category: "candlestick",
      internalLink: "/candlestick/shanghai-index",
    },
    {
      id: "candlestick-large",
      title: "Large Scale Candlestick",
      category: "candlestick",
      internalLink: "/candlestick/large-scale-candlestick",
    },
    {
      id: "candlestick-touch",
      title: "Axis Pointer Link and Touch",
      category: "candlestick",
      internalLink: "/candlestick/axis-pointer-link-and-touch",
    },
    {
      id: "candlestick-brush",
      title: "Candlestick Brush",
      category: "candlestick",
      internalLink: "/candlestick/candlestick-brush",
    },
  ],
  radar: [
    {
  ...
  heatmap: [
    ...
    },
    {
      ...
      category: "heatmap",
      internalLink: "/heatmap/heatmap-discrete-mapping-of-color",
    },
    {
      id: "calendar-heatmap",
      title: "Calendar Heatmap",
      category: "heatmap",
      internalLink: "/heatmap/calendar-heatmap",
    },
  ],
  graph: [
    {
