  ...
  return (
    <header className="h-[50px] bg-white flex items-center justify-between px-5 shadow-[0_2px_8px_rgba(0,0,0,0.08)] relative z-50">
      ...
      <div className="flex items-center gap-4">
        <Link
          to="/examples"
          className="text-sm text-(--viridis-mid) hover:text-(--viridis-light) transition-colors"
        >
          Exemples
        </Link>
        <Link
        ...
        <a
          ...
          className="text-(--viridis-mid) hover:text-(--viridis-light) transition-colors cursor-pointer"
        >
